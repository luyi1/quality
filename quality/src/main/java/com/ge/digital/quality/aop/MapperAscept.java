package com.ge.digital.quality.aop;
...
public class MapperAscept {
	...
	@Pointcut("execution(* com.ge.digital.quality.mapper.*Repository.save(*))")
	...
	@Pointcut("execution(* com.ge.digital.quality.service.*Service.update(*))")
